...
const Home: FC = () => {
  ...
  const [buildingFile, setBuildingFile] = useState<File | null | undefined>(
    null
  );
    ...
    <div>
      <StyledHomeWrapper>
        <StyledHomeContentWrapper>
          ...
          <StyledContentButton onClick={scrollToDeals}>
            Get Started
          </StyledContentButton>
        </StyledHomeContentWrapper>
      </StyledHomeWrapper>
        ...
        <Modal open={modal} onClose={closeModal}>
          <StyledModalContainer>
            ...
            <StyledModalInput
              ...
              value={buildingDhs}
              placeholder="Dhs..."
              onChange={(e) => setBuildingDhs(e.target.value)}
            />
            <StyledModalInput
              type="text"
              value={tiketDhs}
              placeholder="Tiket Dhs..."
              onChange={(e) => setTiketDhs(e.target.value)}
            />
            <StyledModalInput
              type="text"
              value={buildingYield}
              placeholder="Yield..."
              onChange={(e) => setBuildingYield(e.target.value)}
            />
            <StyledModalInput
              type="text"
              value={daysLeft}
